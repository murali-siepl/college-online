  ...
  return (
    <div className="relative bg-gray-100 w-full h-[5080px] overflow-hidden text-left text-3xl text-gray-300 font-poppins">
      ...
      <div className="absolute top-[13px] left-[1119px] w-[124px] h-12 text-sm text-white">
        ...
        <b className="absolute top-[13.5px] left-[34px] uppercase">Sing Up</b>
      </div>
      <div className="absolute top-[252.5px] left-[123px] w-[548px] h-[343px] text-33xl text-mediumslateblue-100">
        <div className="absolute top-[0px] left-[0px] leading-[66px] inline-block w-[548px]">
          <p className="m-0">
          ...
          <p className="m-0">
            ...
            <span className="font-medium font-poppins text-gray-300"> any</span>
          </p>
          <p className="m-0 font-medium text-gray-300">where easily!</p>
        </div>
        <div className="absolute top-[205px] left-[0px] text-mini leading-[22px] text-gray-200 inline-block w-[548px]">
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry. Lorem Ipsum has been the industry's standard dummy text ever
          since the 1500s.....
        </div>
        <div className="absolute top-[295px] left-[0px] w-[341px] h-12 text-sm text-gray-300">
          ...
          <div className="absolute top-[8px] left-[194px] w-[147px] h-8 text-[12px]">
            <b className="absolute top-[7px] left-[38px]">See how it works?</b>
            <img
      ...
      <b className="absolute top-[3178px] left-[809.1px]">Pick an Instructor</b>
      ...
      <div className="absolute top-[4612px] left-[588px] w-[190px] h-10 text-5xl">
        ...
        <div className="absolute top-[29px] left-[57px] text-base">GERMANY</div>
      </div>
      <img
